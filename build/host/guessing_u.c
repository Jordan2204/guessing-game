...
static const oe_ecall_info_t _guessing_ecall_info_table[] = 
{
    { "enclave_helloworld" },
...
oe_result_t guessing_enclave_helloworld(oe_enclave_t* enclave)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _guessing_ecall_info_table[guessing_fcn_id_enclave_helloworld].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(guessing_enclave_helloworld, enclave_helloworld);

oe_result_t guessing_enclave_guessing_init(
    ...
    int max)
{
    ...
    /* Marshalling struct. */
    enclave_guessing_init_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(enclave_guessing_init_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(enclave_guessing_init_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (enclave_guessing_init_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _guessing_ecall_info_table[guessing_fcn_id_enclave_guessing_init].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (enclave_guessing_init_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
OE_WEAK_ALIAS(guessing_enclave_guessing_init, enclave_guessing_init);

oe_result_t guessing_enclave_guessing_send(
    oe_enclave_t* enclave,
    int value)
{
    oe_result_t _result = OE_FAILURE;
    ...
    /* Marshalling struct. */
    enclave_guessing_send_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(enclave_guessing_send_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(enclave_guessing_send_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (enclave_guessing_send_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _guessing_ecall_info_table[guessing_fcn_id_enclave_guessing_send].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (enclave_guessing_send_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
OE_WEAK_ALIAS(guessing_enclave_guessing_send, enclave_guessing_send);

oe_result_t guessing_oe_get_sgx_report_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    ...
    sgx_report_t* report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _guessing_ecall_info_table[guessing_fcn_id_oe_get_sgx_report_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(guessing_oe_get_sgx_report_ecall, oe_get_sgx_report_ecall);

oe_result_t guessing_oe_get_report_v2_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    uint32_t flags,
    const void* opt_params,
    ...
    size_t* report_buffer_size)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _guessing_ecall_info_table[guessing_fcn_id_oe_get_report_v2_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(guessing_oe_get_report_v2_ecall, oe_get_report_v2_ecall);

oe_result_t guessing_oe_verify_local_report_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    ...
    oe_report_t* parsed_report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _guessing_ecall_info_table[guessing_fcn_id_oe_verify_local_report_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(guessing_oe_verify_local_report_ecall, oe_verify_local_report_ecall);

oe_result_t guessing_oe_sgx_init_context_switchless_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    oe_host_worker_context_t* host_worker_contexts,
    uint64_t num_host_workers)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _guessing_ecall_info_table[guessing_fcn_id_oe_sgx_init_context_switchless_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(guessing_oe_sgx_init_context_switchless_ecall, oe_sgx_init_context_switchless_ecall);

oe_result_t guessing_oe_sgx_switchless_enclave_worker_thread_ecall(
    oe_enclave_t* enclave,
    oe_enclave_worker_context_t* context)
{
    oe_result_t _result = OE_FAILURE;
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _guessing_ecall_info_table[guessing_fcn_id_oe_sgx_switchless_enclave_worker_thread_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(guessing_oe_sgx_switchless_enclave_worker_thread_ecall, oe_sgx_switchless_enclave_worker_thread_ecall);
...
static void ocall_host_guessing_init(
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    host_guessing_init_args_t* _pargs_in = (host_guessing_init_args_t*)input_buffer;
    host_guessing_init_args_t* _pargs_out = (host_guessing_init_args_t*)output_buffer;
...
static void ocall_host_guessing_result(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    host_guessing_result_args_t* _pargs_in = (host_guessing_result_args_t*)input_buffer;
    host_guessing_result_args_t* _pargs_out = (host_guessing_result_args_t*)output_buffer;
...
static oe_ocall_func_t _guessing_ocall_function_table[] = {
    (oe_ocall_func_t) ocall_host_guessing_init,
    (oe_ocall_func_t) ocall_host_guessing_result,
...
oe_result_t oe_create_guessing_enclave(
    const char* path,
    ...
    oe_enclave_t** enclave)
{
    return oe_create_enclave(
               ...
               settings,
               setting_count,
               _guessing_ocall_function_table,
               85,
               _guessing_ecall_info_table,
                8,
               enclave);
}
