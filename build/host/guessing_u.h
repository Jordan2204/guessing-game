 ...
 */
#ifndef EDGER8R_GUESSING_U_H
#define EDGER8R_GUESSING_U_H

#include <openenclave/host.h>

#include "guessing_args.h"
...
oe_result_t enclave_guessing_init(
    oe_enclave_t* enclave,
    int max);

oe_result_t enclave_guessing_send(
    oe_enclave_t* enclave,
    int value);
