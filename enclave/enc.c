...
#include "host_guessing_init_t.h"
#include "host_guessing_send_t.h"

// This is the function that the host calls. It prints
// a message in the enclave before calling back out to
// the host to print a message from there too.
void enclave_guessing()
{
    ...
    oe_result_t result = host_guessing();
    if (result != OE_OK)
    {
        fprintf(
            stderr,
            "Call to host_guessing failed: result=%u (%s)\n",
            result,
